...
export const logIn =
  (payload: { email: string; password: string }) => (dispatch: Dispatch) => {
...
export const makeRegistration =
  (payload: { name: string; email: string, password: string }) => (dispatch: Dispatch) => {
...
export const makeNewOrder =
  (id: MakeNewOrderPayload) => (dispatch: Dispatch) => {
...
export const getDataOfOrder = (id: string) => (dispatch: Dispatch) => {
  getOrder(id)
    .then((res) => {
      if (res.success) {
